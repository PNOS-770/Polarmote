...
class SshForegroundService : Service() {
    companion object {
        private const val CHANNEL_ID = "asmote_ssh_foreground"
        private const val CHANNEL_NAME = "Asmote SSH"
        private const val NOTIFICATION_ID = 7702
        private const val WAKE_LOCK_TAG = "asmote:ssh_foreground"
        private const val WIFI_LOCK_TAG = "asmote:ssh_wifi_foreground"
        ...
        private fun buildNotification(context: Context): Notification {
            ...
            val title = if (lastTitle.isBlank()) "Asmote SSH" else lastTitle
