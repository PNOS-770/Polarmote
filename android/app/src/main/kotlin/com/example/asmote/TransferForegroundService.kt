...
class TransferForegroundService : Service() {
    companion object {
        private const val CHANNEL_ID = "asmote_transfer_foreground"
        private const val CHANNEL_NAME = "Asmote Transfer"
        private const val NOTIFICATION_ID = 7701
        private const val WAKE_LOCK_TAG = "asmote:transfer_foreground"
        private const val WIFI_LOCK_TAG = "asmote:transfer_wifi_foreground"
        ...
        private fun buildNotification(context: Context): Notification {
            ...
            val title = if (lastTitle.isBlank()) "Asmote" else lastTitle
