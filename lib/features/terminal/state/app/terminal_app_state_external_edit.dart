...
import '../../presentation/common/terminal_localization.dart';
...
extension TerminalAppStateExternalEdit on TerminalAppState {
  ...
  Future<InternalViewerPreparationResult?> prepareFileForInternalViewerDetailed(
    ...
    try {
      ...
      final operation = l(this, AppStrings.values.preparePreview);
      setError(
        formatPathError(
          diagnostic,
          languageCode: locale.languageCode,
  ...
  Future<void> _openLocalFile(String path) async {
    try {
      ...
      final operation = l(this, AppStrings.values.openLocalFile);
      setError(
        formatPathError(
          diagnostic,
          languageCode: locale.languageCode,
