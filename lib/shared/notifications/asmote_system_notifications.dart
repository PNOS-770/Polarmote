...
import '../logging/asmote_log.dart';

class AsmoteSystemNotifications {
  AsmoteSystemNotifications._();
    ...
    try {
      const settings = InitializationSettings(
        ...
        windows: WindowsInitializationSettings(
          appName: 'Asmote',
          appUserModelId: 'com.example.asmote',
      ...
      AsmoteLog.warn('notifications', 'init failed: $error');
    }
  }
  ...
  static Future<void> showScriptResult({
    ...
    try {
      ...
      AsmoteLog.warn('notifications', 'show script result failed: $error');
    }
  }
}
